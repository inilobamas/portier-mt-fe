...
interface EmployeeModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (employeeData: { id?: number, name: string; email: string, phone: string, company_id?: number }) => void;
    companies: Company[];
    initialData?: { id: number, name: string; email: string, phone: string, company_id: number };
}
...
const EmployeeModal: React.FC<EmployeeModalProps> = ({ isOpen, onClose, onSubmit, companies, initialData }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        onSubmit({ id, name, email, phone, company_id });
        onClose();
    };
